...
export default function Header({ sidebarStateUpdate, sidebarOpen }) {
        ...
        <>
            ...
            <nav className="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul className="navbar-nav">
                    <li className="nav-item" onClick={() => sidebarOpen === true
                        ? sidebarStateUpdate(false)
                        : sidebarStateUpdate(true)}>
